...
void handleAPI() {
  ...
  else if (request == "drainage_drain_now") {
    drainage.drainStart();
    sendSettingsJSON();
  }
  else if (request == "drainage_set_automatic") {
    drainage.drainStop();
    sendSettingsJSON();
  }
  else if (request == "get_flowsensor_calibration") {
  ...
  else if (request == "stop_flowsensor_calibration") {
    handleCalibrateFlowsensorsActionStop();
    getFlowsensorCalibration();
  }
  else if (request == "get_message_log") {
    sendMessageLog();
  }
}
